      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.body}>
          <SurfaceCard>
            ...
            <InfoRow icon={<Mail color={colors.slate} size={18} />} text={user?.email || 'No email available'} />
            <InfoRow icon={<Shield color={colors.slate} size={18} />} text="Student Account" />
          </SurfaceCard>
          <SurfaceCard>
            ...
            <Toggle label="Email Notifications" value={emailNotifications} onValueChange={setEmailNotifications} />
            <Toggle label="Assessment Reminders" value={assessmentReminders} onValueChange={setAssessmentReminders} />
            <Toggle label="New Results" value={newResults} onValueChange={setNewResults} />
          </SurfaceCard>
          <SurfaceCard>
            <View style={styles.sectionHeader}>
            ...
            <Text style={styles.muted}>Peer Assessment Platform · Powered by Roble</Text>
          </SurfaceCard>
...
const styles = StyleSheet.create({
  ...
  avatar: { width: 68, height: 68, borderRadius: 34, backgroundColor: colors.tint, alignItems: 'center', justifyContent: 'center' },
  flex: { flex: 1 },
  name: { color: '#111827', fontSize: 18, fontWeight: '900' },
  muted: { color: colors.muted, marginTop: 6 },
  infoRow: { flexDirection: 'row', gap: 12, alignItems: 'center', marginTop: 14 },
